      ...
      {KPI_CONFIG.map((cfg) => {
        ...
        return (
          <div
            ...
            className={cn(
              "glass-panel interactive-spotlight glow-ring lift-card motion-tile stagger-in relative flex min-h-[9.5rem] flex-col gap-4 overflow-hidden rounded-[1.75rem] p-4",
              clickable &&
                "cursor-pointer"
            )}
