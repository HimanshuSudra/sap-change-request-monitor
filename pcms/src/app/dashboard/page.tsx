...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      <section
        className="stagger-in glass-panel interactive-spotlight hero-grid glow-ring motion-tile relative overflow-hidden rounded-[2rem] border-white/50 px-6 py-8 md:px-8"
